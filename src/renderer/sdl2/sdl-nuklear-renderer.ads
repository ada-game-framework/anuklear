...
package SDL.Nuklear.Renderer is
  ...
  --  
   ...
   function sdl_init (win : SDL.C_Pointers.Windows_Pointer; renderer : SDL.C_Pointers.Renderer_Pointer) return access nk_context  -- ./include/nuklear_sdl_renderer.h:15
   with Import => True, 
        Convention => C, 
        External_Name => "nk_sdl_init";

   
   procedure sdl_font_stash_begin (atlas : in out font_atlas_access)  -- ./include/nuklear_sdl_renderer.h:16
   with Import => True, 
        Convention => C, 
   ...
   function sdl_handle_event (evt : in out SDL.Events.Events.Events) return Interfaces.C.int  -- ./include/nuklear_sdl_renderer.h:18
   with Import => True, 
        Convention => C, 
        External_Name => "nk_sdl_handle_event";

   procedure sdl_render (arg1 : nk_anti_aliasing)  -- ./include/nuklear_sdl_renderer.h:19
   with Import => True, 
        Convention => C, 
        External_Name => "nk_sdl_render";

   procedure sdl_shutdown  -- ./include/nuklear_sdl_renderer.h:20
   with Import => True, 
        Convention => C, 
